...
class EditDialog(tk.Toplevel):
    def __init__(self, root, values):
        ...
        label_city.grid(column=0, row=1, padx=g_padx, pady=g_pady, sticky='w')

        label_date = tk.Label(self, text="Date")
        label_date.grid(column=0, row=2, padx=g_padx, pady=g_pady, sticky='w')

        label_max_temp = tk.Label(self, text="Max temperature")
        label_max_temp.grid(column=0, row=3, padx=g_padx, pady=g_pady, sticky='w')

        label_min_temp = tk.Label(self, text="Min temperature")
        label_min_temp.grid(column=0, row=4, padx=g_padx, pady=g_pady, sticky='w')

        label_press = tk.Label(self, text="Pressure")
        label_press.grid(column=0, row=5, padx=g_padx, pady=g_pady, sticky='w')

        label_wind = tk.Label(self, text="Wind")
        label_wind.grid(column=0, row=6, padx=g_padx, pady=g_pady, sticky='w')

        label_falls = tk.Label(self, text="Falls")
        label_falls.grid(column=0, row=7, padx=g_padx, pady=g_pady, sticky='w')

        self.text_id = tk.StringVar()
        self.text_id.set(values[0])
        self.entry_id = tk.Entry(self, state='readonly', textvariable=self.text_id)
        ...
        self.entry_city.grid(column=1, row=1, padx=g_padx)

        self.text_date = tk.StringVar()
        self.text_date.set(values[2])
        self.entry_date = tk.Entry(self, textvariable=self.text_date)
        self.entry_date.grid(column=1, row=2, padx=g_padx)
        ...
        self.entry_max_temp.grid(column=1, row=3, padx=g_padx)
        ...
        self.entry_min_temp.grid(column=1, row=4, padx=g_padx)

        self.text_press = tk.StringVar()
        self.text_press.set(values[5])
        self.entry_press = tk.Entry(self, textvariable=self.text_press)
        self.entry_press.grid(column=1, row=5, padx=g_padx)

        self.text_wind = tk.StringVar()
        self.text_wind.set(str(values[6]))
        self.entry_wind = tk.Entry(self, textvariable=self.text_wind)
        self.entry_wind.grid(column=1, row=6, padx=g_padx)

        self.text_falls = tk.StringVar()
        self.text_falls.set(str(values[7]))
        self.entry_falls = tk.Entry(self, textvariable=self.text_falls)
        self.entry_falls.grid(column=1, row=7, padx=g_padx)

        self.ok_button = tk.Button(self, text="OK", width=10, command=self.on_ok_button)
        self.ok_button.grid(column=2, row=7, padx=g_padx, pady=g_pady)

        self.cancel_button = tk.Button(self, text="Cancel", width=10, command=self.on_cancel_button)
        self.cancel_button.grid(column=2, row=6, padx=g_padx, pady=g_pady)
